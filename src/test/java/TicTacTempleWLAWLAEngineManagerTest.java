...
public class TicTacTempleWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(TicTacTempleWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/TicTacTempleWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/TicTacTempleWLAIW/InitOutcome.xml").getDocumentElement();
